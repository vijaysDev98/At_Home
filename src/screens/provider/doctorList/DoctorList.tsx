        ...
        return (
            ...
            >
                <ProfileAvatar
                    ...
                    imageUrl={doctor?.profileImg ? IMAGE_BASE_URL + doctor.profileImg : undefined}
                    size='medium'
                />
                                            ...
                                            renderItem={({ item: chip }) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <AppText
                                                            color={
                                                                selectedChip === chipValue ? COLORS.white : COLORS._6F767E
                                                            }
                                                            size={getScaleSize(12)}
                                                            font={
                                                                selectedChip === chipValue
                                    ...
                                    !isLoading ? (
                                        <View style={styles.emptyContainer}>
                                            <AppText color={COLORS._6F767E}>
                                                {t(search ? STRING.noDoctorsFound : STRING.noDoctorsAvailable)}
                                            </AppText>
                                        </View>
                                    ) : null
                                }
