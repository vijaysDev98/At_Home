export const STRING = {
  ...
  dischargeInstructionsSubtitle: 'Provide instructions using voice recording, written notes, or both.',
  ...
  pleaseProvideInstructions: 'Please provide pre-request instructions using voice recording or written notes.',
